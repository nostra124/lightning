# Milestone 1.5.0 — self-contained packaging, standards & docs
...
Once the verb surface is complete (1.1.0 → 1.4.0), this
...
2. **FEAT-178 — vendor Lightning standards** — BOLT 1..11 +
   ...
   from the 1.0.0 import; this finishes the vendoring).
...
- `docs/lightning.md` covers every verb shipped through 1.4.0.
...
- Unit test contract extended (help / man / standards
  presence).
- `.rpk/version` bumped 1.4.0 → 1.5.0; ledger updated.
- FEAT-177, FEAT-178, FEAT-179, FEAT-180 move to
  `issues/feature/done/`.

## Dependencies

Hard: 1.4.0 (the surface that gets documented).
