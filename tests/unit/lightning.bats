...
@test "FEAT-2051: node-listpays-by-day reports error or pays_by_day gracefully" {
    out=$(./libexec/lightning/node-listpays-by-day 2>/dev/null)
    echo "$out" | grep -q "error\|pays_by_day"
}
@test "FEAT-2051: node-listpays-by-day man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-by-day.1" ]
}

@test "FEAT-2052: channel-htlc-timeout reports error or htlc_timeouts gracefully" {
    out=$(./libexec/lightning/channel-htlc-timeout 2>/dev/null)
    echo "$out" | grep -q "error\|htlc_timeouts"
}
@test "FEAT-2052: channel-htlc-timeout man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-timeout.1" ]
}

@test "FEAT-2053: wallet-notes-recent reports error or recent_notes gracefully" {
    out=$(./libexec/lightning/wallet-notes-recent 2>/dev/null)
    echo "$out" | grep -q "error\|recent_notes"
}
@test "FEAT-2053: wallet-notes-recent man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-recent.1" ]
}

@test "FEAT-2054: node-graph-top-capacity reports error or top_capacity gracefully" {
    out=$(./libexec/lightning/node-graph-top-capacity 2>/dev/null)
    echo "$out" | grep -q "error\|top_capacity"
}
...
@test "FEAT-2055: channel-short-channel-id reports error or channels gracefully" {
    out=$(./libexec/lightning/channel-short-channel-id 2>/dev/null)
    echo "$out" | grep -q "error\|channels"
}
...
@test "FEAT-2056: peer-total-sent-msat reports error or total_sent_msat gracefully" {
    out=$(./libexec/lightning/peer-total-sent-msat 2>/dev/null)
    echo "$out" | grep -q "error\|total_sent_msat"
}
@test "FEAT-2056: peer-total-sent-msat man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-total-sent-msat.1" ]
}

@test "FEAT-2057: node-invoice-amount-avg reports error or avg_amount_msat gracefully" {
...
@test "FEAT-2058: channel-balance-summary reports error or total_local_msat gracefully" {
    out=$(./libexec/lightning/channel-balance-summary 2>/dev/null)
    echo "$out" | grep -q "error\|total_local_msat"
}
...
@test "FEAT-2059: node-pay-fee-pct reports error or fee_pct gracefully" {
    out=$(./libexec/lightning/node-pay-fee-pct 2>/dev/null)
    echo "$out" | grep -q "error\|fee_pct"
}
@test "FEAT-2059: node-pay-fee-pct man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-pct.1" ]
}

@test "FEAT-2060: channel-initiator reports error or channels gracefully" {
    out=$(./libexec/lightning/channel-initiator 2>/dev/null)
    echo "$out" | grep -q "error\|channels"
}
...
@test "FEAT-2081: node-listpays-amount-total reports error or amount_sent_total gracefully" {
    out=$(./libexec/lightning/node-listpays-amount-total 2>/dev/null)
    echo "$out" | grep -q "error\|amount_sent_total"
}
@test "FEAT-2081: node-listpays-amount-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-amount-total.1" ]
}

@test "FEAT-2082: channel-their-fee-summary reports error or their_fee_summary gracefully" {
    out=$(./libexec/lightning/channel-their-fee-summary 2>/dev/null)
    echo "$out" | grep -q "error\|their_fee_summary"
}
...
@test "FEAT-2083: wallet-notes-count reports error or notes_count gracefully" {
    out=$(./libexec/lightning/wallet-notes-count 2>/dev/null)
    echo "$out" | grep -q "error\|notes_count"
}
@test "FEAT-2083: wallet-notes-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-count.1" ]
}

@test "FEAT-2084: node-graph-ppm-stats reports error or ppm_min gracefully" {
    out=$(./libexec/lightning/node-graph-ppm-stats 2>/dev/null)
    echo "$out" | grep -q "error\|ppm_min"
}
@test "FEAT-2084: node-graph-ppm-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-ppm-stats.1" ]
}

@test "FEAT-2085: channel-receivable-pct reports error or receivable_pct gracefully" {
    out=$(./libexec/lightning/channel-receivable-pct 2>/dev/null)
    echo "$out" | grep -q "error\|receivable_pct\|channels"
}
...
@test "FEAT-2086: peer-remote-balance-total reports error or peer_remote_balances gracefully" {
...
@test "FEAT-2087: node-invoice-largest reports error or largest_invoice gracefully" {
    out=$(./libexec/lightning/node-invoice-largest 2>/dev/null)
    echo "$out" | grep -q "error\|largest_invoice"
}
@test "FEAT-2087: node-invoice-largest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-largest.1" ]
}

@test "FEAT-2088: channel-spendable-rank reports error or channels gracefully" {
    out=$(./libexec/lightning/channel-spendable-rank 2>/dev/null)
    echo "$out" | grep -q "error\|channels"
}
...
@test "FEAT-2089: node-pay-max-msat reports error or max_amount_sent_msat gracefully" {
    out=$(./libexec/lightning/node-pay-max-msat 2>/dev/null)
    echo "$out" | grep -q "error\|max_amount_sent_msat"
}
...
@test "FEAT-2090: channel-capacity-total-sat reports error or capacity_total_sat gracefully" {
    out=$(./libexec/lightning/channel-capacity-total-sat 2>/dev/null)
    echo "$out" | grep -q "error\|capacity_total_sat"
}
...
@test "FEAT-2111: node-listforwards-summary reports error or settled gracefully" {
    out=$(./libexec/lightning/node-listforwards-summary 2>/dev/null)
    echo "$out" | grep -q "error\|settled"
}
...
@test "FEAT-2112: channel-age-stats reports error or count gracefully" {
    out=$(./libexec/lightning/channel-age-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2113: wallet-notes-tag-summary reports error or tags gracefully" {
    out=$(./libexec/lightning/wallet-notes-tag-summary 2>/dev/null)
    echo "$out" | grep -q "error\|tags"
}
...
@test "FEAT-2114: node-graph-node-list reports error or nodes gracefully" {
    out=$(./libexec/lightning/node-graph-node-list 2>/dev/null)
    echo "$out" | grep -q "error\|nodes"
}
...
@test "FEAT-2115: channel-local-balance-stats reports error or count gracefully" {
    out=$(./libexec/lightning/channel-local-balance-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2116: peer-channel-summary reports error or total gracefully" {
    out=$(./libexec/lightning/peer-channel-summary 2>/dev/null)
    echo "$out" | grep -q "error\|total"
}
...
@test "FEAT-2117: node-invoice-amount-stats reports error or count gracefully" {
    out=$(./libexec/lightning/node-invoice-amount-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2118: channel-remote-balance-stats reports error or count gracefully" {
    out=$(./libexec/lightning/channel-remote-balance-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2119: node-pay-fee-stats reports error or count gracefully" {
    out=$(./libexec/lightning/node-pay-fee-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2120: channel-htlc-stats reports error or total_htlcs gracefully" {
    out=$(./libexec/lightning/channel-htlc-stats 2>/dev/null)
    echo "$out" | grep -q "error\|total_htlcs"
}
...
@test "FEAT-2141: node-listpays-fee-avg reports error or avg_fee_msat gracefully" {
    out=$(./libexec/lightning/node-listpays-fee-avg 2>/dev/null)
...
@test "FEAT-2142: channel-funding-stats reports error or count gracefully" {
    out=$(./libexec/lightning/channel-funding-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2143: wallet-notes-stats reports error or count gracefully" {
    out=$(./libexec/lightning/wallet-notes-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2144: node-graph-degree-stats reports error or count gracefully" {
    out=$(./libexec/lightning/node-graph-degree-stats 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2145: channel-imbalance-list reports error or count gracefully" {
    out=$(./libexec/lightning/channel-imbalance-list 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2146: peer-htlc-revenue reports error or count gracefully" {
    out=$(./libexec/lightning/peer-htlc-revenue 2>/dev/null)
    echo "$out" | grep -q "error\|count"
}
...
@test "FEAT-2147: node-invoice-count-by-status reports error or total gracefully" {
    out=$(./libexec/lightning/node-invoice-count-by-status 2>/dev/null)
    echo "$out" | grep -q "error\|total"
}
...
@test "FEAT-2148: channel-age-oldest reports error or oldest gracefully" {
    out=$(./libexec/lightning/channel-age-oldest 2>/dev/null)
    echo "$out" | grep -q "error\|oldest"
}
@test "FEAT-2148: channel-age-oldest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-age-oldest.1" ]
}

@test "FEAT-2149: node-pay-count-total reports error or total gracefully" {
    out=$(./libexec/lightning/node-pay-count-total 2>/dev/null)
    echo "$out" | grep -q "error\|total"
}
...
@test "FEAT-2150: channel-age-newest reports error or newest gracefully" {
    out=$(./libexec/lightning/channel-age-newest 2>/dev/null)
    echo "$out" | grep -q "error\|newest"
}
