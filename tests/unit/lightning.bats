...
@test "FEAT-2051: node-listpays-by-day man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-by-day.1" ]
}

@test "FEAT-2052: channel-htlc-timeout man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-timeout.1" ]
}

@test "FEAT-2053: wallet-notes-recent man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-recent.1" ]
}

@test "FEAT-2054: node-graph-top-capacity man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-top-capacity.1" ]
}

@test "FEAT-2055: channel-short-channel-id man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-short-channel-id.1" ]
}

@test "FEAT-2056: peer-total-sent-msat man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-total-sent-msat.1" ]
}

@test "FEAT-2057: node-invoice-amount-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-amount-avg.1" ]
}

@test "FEAT-2058: channel-balance-summary man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-balance-summary.1" ]
}

@test "FEAT-2059: node-pay-fee-pct man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-pct.1" ]
}
...
@test "FEAT-2081: node-listpays-amount-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-amount-total.1" ]
}

@test "FEAT-2082: channel-their-fee-summary man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-their-fee-summary.1" ]
}

@test "FEAT-2083: wallet-notes-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-count.1" ]
}

@test "FEAT-2084: node-graph-ppm-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-ppm-stats.1" ]
}

@test "FEAT-2085: channel-receivable-pct man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-pct.1" ]
}

@test "FEAT-2086: peer-remote-balance-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-remote-balance-total.1" ]
}

@test "FEAT-2087: node-invoice-largest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-largest.1" ]
}

@test "FEAT-2088: channel-spendable-rank man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-rank.1" ]
}

@test "FEAT-2089: node-pay-max-msat man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-max-msat.1" ]
}
...
@test "FEAT-2111: node-listforwards-summary man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-summary.1" ]
}

@test "FEAT-2112: channel-age-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-age-stats.1" ]
}

@test "FEAT-2113: wallet-notes-tag-summary man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-tag-summary.1" ]
}

@test "FEAT-2114: node-graph-node-list man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-node-list.1" ]
}

@test "FEAT-2115: channel-local-balance-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-stats.1" ]
}

@test "FEAT-2116: peer-channel-summary man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-channel-summary.1" ]
}

@test "FEAT-2117: node-invoice-amount-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-amount-stats.1" ]
}

@test "FEAT-2118: channel-remote-balance-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-remote-balance-stats.1" ]
}

@test "FEAT-2119: node-pay-fee-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-stats.1" ]
}
...
@test "FEAT-2141: node-listpays-fee-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-fee-avg.1" ]
}

@test "FEAT-2142: channel-funding-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-funding-stats.1" ]
}

@test "FEAT-2143: wallet-notes-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-stats.1" ]
}

@test "FEAT-2144: node-graph-degree-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-degree-stats.1" ]
}

@test "FEAT-2145: channel-imbalance-list man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-imbalance-list.1" ]
}

@test "FEAT-2146: peer-htlc-revenue man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-htlc-revenue.1" ]
}

@test "FEAT-2147: node-invoice-count-by-status man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-count-by-status.1" ]
}

@test "FEAT-2148: channel-age-oldest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-age-oldest.1" ]
}

@test "FEAT-2149: node-pay-count-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-total.1" ]
}
...
@test "FEAT-2191: node-listpays-complete-fee-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listpays-complete-fee-avg.1" ]
}

@test "FEAT-2192: channel-htlc-in-flight-stats man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-in-flight-stats.1" ]
}

@test "FEAT-2193: wallet-notes-unpin man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-wallet-notes-unpin.1" ]
}

@test "FEAT-2194: node-graph-fee-ppm-median man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-fee-ppm-median.1" ]
}

@test "FEAT-2195: channel-state-closing-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-state-closing-count.1" ]
}

@test "FEAT-2196: peer-local-pct-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-pct-avg.1" ]
}

@test "FEAT-2197: node-invoice-paid-count-recent man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-count-recent.1" ]
}

@test "FEAT-2198: channel-local-balance-smallest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-smallest.1" ]
}

@test "FEAT-2199: node-pay-complete-oldest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-complete-oldest.1" ]
}
...
@test "FEAT-2231: channel-balance-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-balance-total.1" ]
}

@test "FEAT-2232: node-pay-count-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-total.1" ]
}

@test "FEAT-2233: channel-fee-base-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-base-max.1" ]
}

@test "FEAT-2234: peer-uptime-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-uptime-avg.1" ]
}

@test "FEAT-2235: node-listinvoices-amount-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-amount-total.1" ]
}

@test "FEAT-2236: channel-htlc-min-msat man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-min-msat.1" ]
}

@test "FEAT-2237: node-graph-betweenness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-graph-betweenness.1" ]
}

@test "FEAT-2238: channel-fee-ppm-median man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-median.1" ]
}

@test "FEAT-2239: node-pay-recent man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-recent.1" ]
}
...
@test "FEAT-2271: node-listforwards-oldest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-oldest.1" ]
}

@test "FEAT-2272: channel-htlc-pending-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-pending-count.1" ]
}

@test "FEAT-2273: peer-connected-list man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-connected-list.1" ]
}

@test "FEAT-2274: node-invoice-newest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-newest.1" ]
}

@test "FEAT-2275: channel-fee-ppm-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-avg.1" ]
}

@test "FEAT-2276: node-pay-count-by-day man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-by-day.1" ]
}

@test "FEAT-2277: channel-capacity-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-capacity-min.1" ]
}

@test "FEAT-2278: peer-fee-base-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-base-avg.1" ]
}

@test "FEAT-2279: node-listinvoices-paid-list man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-list.1" ]
}
...
@test "FEAT-2371: node-listforwards-in-msat-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-in-msat-avg.1" ]
}

@test "FEAT-2372: channel-htlc-expiry-soonest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-expiry-soonest.1" ]
}

@test "FEAT-2373: peer-remote-balance-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-remote-balance-max.1" ]
}

@test "FEAT-2374: node-invoice-expiry-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-expiry-min.1" ]
}

@test "FEAT-2375: channel-fee-base-max-channel man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-base-max-channel.1" ]
}

@test "FEAT-2376: node-pay-count-90d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-90d.1" ]
}

@test "FEAT-2377: channel-receivable-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-max.1" ]
}

@test "FEAT-2378: peer-oldest-channel man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-oldest-channel.1" ]
}

@test "FEAT-2379: node-listinvoices-paid-amount-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-amount-total.1" ]
}
...
@test "FEAT-2401: node-listforwards-settled-newest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-settled-newest.1" ]
}

@test "FEAT-2402: channel-htlc-value-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-value-avg.1" ]
}

@test "FEAT-2403: peer-local-balance-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-balance-min.1" ]
}

@test "FEAT-2404: node-invoice-paid-last-30d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-last-30d.1" ]
}

@test "FEAT-2405: channel-fee-earned-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-earned-avg.1" ]
}

@test "FEAT-2406: node-pay-volume-7d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-volume-7d.1" ]
}

@test "FEAT-2407: channel-capacity-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-capacity-avg.1" ]
}

@test "FEAT-2408: peer-htlc-value-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-htlc-value-avg.1" ]
}

@test "FEAT-2409: node-listinvoices-amount-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-amount-min.1" ]
}

@test "FEAT-2410: channel-remote-balance-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-remote-balance-avg.1" ]
}

@test "FEAT-2411: node-listforwards-fee-total-30d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-total-30d.1" ]
}

@test "FEAT-2412: channel-spendable-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-avg.1" ]
}

@test "FEAT-2413: peer-newest-invoice-paid man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-newest-invoice-paid.1" ]
}

@test "FEAT-2414: node-invoice-paid-last-90d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-last-90d.1" ]
}

@test "FEAT-2415: channel-fee-ppm-variance man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-variance.1" ]
}

@test "FEAT-2416: node-pay-destination-list man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-destination-list.1" ]
}

@test "FEAT-2417: channel-local-htlc-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-htlc-count.1" ]
}

@test "FEAT-2418: peer-fee-ppm-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-ppm-min.1" ]
}

@test "FEAT-2419: node-listinvoices-pending-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-pending-count.1" ]
}
...
@test "FEAT-2441: node-listforwards-fee-total-48h man page exists" {
...
@test "FEAT-2443: peer-capacity-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-capacity-avg.1" ]
}

@test "FEAT-2444: node-invoice-unpaid-rate man page exists" {
...
@test "FEAT-2446: node-pay-complete-count-7d man page exists" {
...
@test "FEAT-2449: node-listinvoices-paid-newest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-newest.1" ]
}

@test "FEAT-2450: channel-local-balance-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-avg.1" ]
}

@test "FEAT-2451: node-listforwards-fee-total-72h man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-total-72h.1" ]
}

@test "FEAT-2452: channel-htlc-incoming-value man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-incoming-value.1" ]
}

@test "FEAT-2453: peer-capacity-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-capacity-max.1" ]
}

@test "FEAT-2454: node-invoice-pending-oldest man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-pending-oldest.1" ]
}

@test "FEAT-2455: channel-fee-ppm-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-max.1" ]
}

@test "FEAT-2456: node-pay-complete-count-30d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-complete-count-30d.1" ]
}

@test "FEAT-2457: channel-capacity-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-capacity-avg.1" ]
}

@test "FEAT-2458: peer-fee-ppm-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-ppm-avg.1" ]
}

@test "FEAT-2459: node-listinvoices-paid-count-7d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-count-7d.1" ]
}

@test "FEAT-2460: channel-local-balance-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-total.1" ]
}

@test "FEAT-2461: node-listforwards-fee-total-14d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-total-14d.1" ]
}

@test "FEAT-2462: channel-htlc-count-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-count-avg.1" ]
}

@test "FEAT-2463: peer-capacity-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-capacity-min.1" ]
}

@test "FEAT-2464: node-invoice-paid-amount-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-amount-total.1" ]
}

@test "FEAT-2465: channel-fee-ppm-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-min.1" ]
}

@test "FEAT-2466: node-pay-complete-count-90d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-complete-count-90d.1" ]
}

@test "FEAT-2467: channel-capacity-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-capacity-total.1" ]
}

@test "FEAT-2468: peer-fee-ppm-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-ppm-min.1" ]
}

@test "FEAT-2469: node-listinvoices-paid-count-30d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-count-30d.1" ]
}

@test "FEAT-2470: channel-remote-balance-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-remote-balance-total.1" ]
}

@test "FEAT-2471: node-listforwards-fee-total-60d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-total-60d.1" ]
}

@test "FEAT-2472: channel-htlc-value-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-value-avg.1" ]
}

@test "FEAT-2473: peer-local-balance-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-balance-total.1" ]
}

@test "FEAT-2474: node-invoice-pending-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-pending-count.1" ]
}

@test "FEAT-2475: channel-fee-base-median man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-base-median.1" ]
}

@test "FEAT-2476: node-pay-complete-count-1y man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-complete-count-1y.1" ]
}

@test "FEAT-2477: channel-capacity-total-btc man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-capacity-total-btc.1" ]
}

@test "FEAT-2478: peer-fee-base-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-base-max.1" ]
}

@test "FEAT-2479: node-listinvoices-paid-count-90d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-count-90d.1" ]
}
...
@test "FEAT-2581: node-listforwards-in-msat-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-in-msat-min.1" ]
}

@test "FEAT-2582: channel-local-balance-top10 man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-top10.1" ]
}

@test "FEAT-2583: peer-our-reserve-total man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-our-reserve-total.1" ]
}

@test "FEAT-2584: node-invoice-paid-last-30d man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-last-30d.1" ]
}

@test "FEAT-2585: channel-spendable-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-min.1" ]
}

@test "FEAT-2586: node-pay-fee-stddev man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-stddev.1" ]
}

@test "FEAT-2587: channel-receivable-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-min.1" ]
}

@test "FEAT-2588: peer-our-reserve-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-our-reserve-max.1" ]
}

@test "FEAT-2589: node-listinvoices-paid-year man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listinvoices-paid-year.1" ]
}
...
@test "FEAT-2691: node-listforwards-settled-rate man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-settled-rate.1" ]
}

@test "FEAT-2692: channel-fee-ppm-top5 man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-ppm-top5.1" ]
}

@test "FEAT-2693: peer-local-pct-avg man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-pct-avg.1" ]
}

@test "FEAT-2694: node-pay-amount-median man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-amount-median.1" ]
}

@test "FEAT-2695: channel-local-reserve-top5 man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-reserve-top5.1" ]
}

@test "FEAT-2696: node-listforwards-failed-count man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-failed-count.1" ]
}

@test "FEAT-2697: channel-remote-reserve-top5 man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-remote-reserve-top5.1" ]
}

@test "FEAT-2698: peer-local-pct-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-pct-max.1" ]
}

@test "FEAT-2699: node-invoice-paid-amount-min man page exists" {
...
@test "FEAT-2811: node-listforwards-out-msat-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-out-msat-kurtosis.1" ]
}

@test "FEAT-2812: channel-remote-balance-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-remote-balance-kurtosis.1" ]
}

@test "FEAT-2813: peer-local-balance-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-balance-skewness.1" ]
}

@test "FEAT-2814: node-pay-fee-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-skewness.1" ]
}

@test "FEAT-2815: channel-spendable-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-kurtosis.1" ]
}

@test "FEAT-2816: node-invoice-paid-amount-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-amount-skewness.1" ]
}

@test "FEAT-2817: channel-receivable-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-kurtosis.1" ]
}

@test "FEAT-2818: peer-remote-balance-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-remote-balance-skewness.1" ]
}

@test "FEAT-2819: node-listforwards-fee-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-kurtosis.1" ]
}
...
@test "FEAT-3501: channel-local-balance-kurtosis-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-kurtosis-weekly.1" ]
}

@test "FEAT-3502: node-pay-amount-range-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-amount-range-yearly.1" ]
}

@test "FEAT-3503: peer-receivable-pct-max man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-max.1" ]
}

@test "FEAT-3504: channel-local-balance-skewness-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-skewness-monthly.1" ]
}

@test "FEAT-3505: node-pay-count-range-daily man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-range-daily.1" ]
}

@test "FEAT-3506: peer-receivable-pct-min man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-min.1" ]
}

@test "FEAT-3507: channel-local-balance-kurtosis-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-kurtosis-monthly.1" ]
}

@test "FEAT-3508: node-pay-count-range-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-range-weekly.1" ]
}

@test "FEAT-3509: peer-receivable-pct-stddev man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-stddev.1" ]
}

@test "FEAT-3510: channel-spendable-balance-skewness-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-balance-skewness-weekly.1" ]
}

@test "FEAT-3511: channel-local-balance-kurtosis-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-local-balance-kurtosis-weekly.1" ]
}

@test "FEAT-3512: node-pay-count-range-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-range-monthly.1" ]
}

@test "FEAT-3513: peer-receivable-pct-variance man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-variance.1" ]
}

@test "FEAT-3514: channel-spendable-balance-kurtosis-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-balance-kurtosis-weekly.1" ]
}

@test "FEAT-3515: node-pay-count-range-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-count-range-yearly.1" ]
}

@test "FEAT-3516: peer-receivable-pct-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-skewness.1" ]
}

@test "FEAT-3517: channel-spendable-balance-skewness-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-balance-skewness-monthly.1" ]
}

@test "FEAT-3518: node-invoice-paid-count-daily man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-count-daily.1" ]
}

@test "FEAT-3519: peer-receivable-pct-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-pct-kurtosis.1" ]
}

@test "FEAT-3520: channel-spendable-balance-kurtosis-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-spendable-balance-kurtosis-monthly.1" ]
}

@test "FEAT-3521: node-invoice-paid-count-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-count-weekly.1" ]
}

@test "FEAT-3522: channel-receivable-balance-skewness-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-balance-skewness-weekly.1" ]
}

@test "FEAT-3523: peer-spendable-balance-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-skewness.1" ]
}

@test "FEAT-3524: node-invoice-paid-count-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-count-monthly.1" ]
}

@test "FEAT-3525: channel-receivable-balance-kurtosis-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-balance-kurtosis-weekly.1" ]
}

@test "FEAT-3526: peer-spendable-balance-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-kurtosis.1" ]
}

@test "FEAT-3527: node-invoice-paid-count-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-count-yearly.1" ]
}

@test "FEAT-3528: channel-receivable-balance-skewness-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-balance-skewness-monthly.1" ]
}

@test "FEAT-3529: peer-receivable-balance-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-balance-skewness.1" ]
}
...
@test "FEAT-3541: channel-both-reserves-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-both-reserves-kurtosis.1" ]
}

@test "FEAT-3542: node-invoice-paid-amount-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-paid-amount-yearly.1" ]
}

@test "FEAT-3543: peer-receivable-balance-skewness-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-balance-skewness-weekly.1" ]
}

@test "FEAT-3544: channel-fee-earned-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-earned-skewness.1" ]
}

@test "FEAT-3545: node-invoice-expired-count-daily man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-expired-count-daily.1" ]
}

@test "FEAT-3546: peer-receivable-balance-kurtosis-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-balance-kurtosis-monthly.1" ]
}

@test "FEAT-3547: channel-fee-earned-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-fee-earned-kurtosis.1" ]
}

@test "FEAT-3548: node-invoice-expired-count-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-expired-count-weekly.1" ]
}

@test "FEAT-3549: peer-spendable-balance-skewness-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-skewness-monthly.1" ]
}
...
@test "FEAT-3561: channel-receivable-balance-kurtosis-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-balance-kurtosis-yearly.1" ]
}

@test "FEAT-3562: node-invoice-unpaid-count-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-unpaid-count-weekly.1" ]
}

@test "FEAT-3563: peer-spendable-balance-skewness-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-skewness-yearly.1" ]
}

@test "FEAT-3564: channel-both-balances-skewness-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-both-balances-skewness-weekly.1" ]
}

@test "FEAT-3565: node-invoice-unpaid-count-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-unpaid-count-monthly.1" ]
}

@test "FEAT-3566: peer-spendable-balance-kurtosis-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-kurtosis-yearly.1" ]
}

@test "FEAT-3567: channel-both-balances-kurtosis-weekly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-both-balances-kurtosis-weekly.1" ]
}

@test "FEAT-3568: node-invoice-unpaid-count-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-invoice-unpaid-count-yearly.1" ]
}

@test "FEAT-3569: peer-receivable-balance-skewness-yearly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-balance-skewness-yearly.1" ]
}
...
@test "FEAT-3601: channel-receivable-balance-range man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-receivable-balance-range.1" ]
}

@test "FEAT-3602: node-pay-amount-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-amount-kurtosis.1" ]
}

@test "FEAT-3603: peer-fee-earned-kurtosis-monthly man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-fee-earned-kurtosis-monthly.1" ]
}

@test "FEAT-3604: channel-both-balances-range man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-both-balances-range.1" ]
}

@test "FEAT-3605: node-listforwards-fee-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-skewness.1" ]
}

@test "FEAT-3606: peer-spendable-balance-range man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-spendable-balance-range.1" ]
}

@test "FEAT-3607: channel-both-reserves-range man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-both-reserves-range.1" ]
}

@test "FEAT-3608: node-listforwards-fee-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-fee-kurtosis.1" ]
}

@test "FEAT-3609: peer-receivable-balance-range man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-receivable-balance-range.1" ]
}
...
@test "FEAT-3621: channel-htlc-min-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-min-kurtosis.1" ]
}

@test "FEAT-3622: node-listforwards-out-msat-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-listforwards-out-msat-kurtosis.1" ]
}

@test "FEAT-3623: peer-local-balance-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-local-balance-kurtosis.1" ]
}

@test "FEAT-3624: channel-htlc-max-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-max-skewness.1" ]
}

@test "FEAT-3625: node-pay-fee-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-skewness.1" ]
}

@test "FEAT-3626: peer-remote-balance-skewness man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-remote-balance-skewness.1" ]
}

@test "FEAT-3627: channel-htlc-max-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-channel-htlc-max-kurtosis.1" ]
}

@test "FEAT-3628: node-pay-fee-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-node-pay-fee-kurtosis.1" ]
}

@test "FEAT-3629: peer-remote-balance-kurtosis man page exists" {
    [ -f "$BATS_TEST_DIRNAME/../../share/man/man1/lightning-peer-remote-balance-kurtosis.1" ]
}
